...
{#if show}
	<div class="absolute bg-gray-100 p-2 border z-10 mt-40 flex items-end flex-col shadow-lg gap-2 rounded-md dark:bg-gray-700">
		<select name="selected" id="selected" bind:value={selected} class="w-full p-2 rounded-lg dark:bg-gray-600">
